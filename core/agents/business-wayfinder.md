...
Regole: applicare la skill Wayfinder installata; seguire `core/TRACKERS.md`; usare grilling e domain-modeling; un solo ticket decisionale per sessione salvo ricerca; non produrre deliverable di implementazione; non modificare codice applicativo; preferire tracker condiviso per progetti Business.
